...
from app.b1_memory_context_readiness import (  # noqa: E402
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Print the current ai-platform B1 memory/context readiness rollup."
    )
    parser.add_argument(
        "--format",
    ...
    if args.format == "json":
        ...
        return
    print(render_b1_memory_context_readiness_markdown(readiness))
