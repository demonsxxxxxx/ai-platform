...
export const workbenchSurface = {
  root: clsx(
    "flex min-h-0 flex-1 bg-slate-100 text-slate-950",
  ...
  thread: clsx(
    ...
    "border-r border-slate-200/80 bg-slate-100",
    "dark:border-stone-800 dark:bg-stone-950",
  ),
  threadBody: "flex min-h-0 flex-1 flex-col px-3 pb-2 sm:px-4",
  composer: clsx(
    "shrink-0 border-t border-slate-200/80 bg-slate-100 px-3 py-2.5",
    "dark:border-stone-800 dark:bg-stone-950",
  ),
  context: clsx(
    "hidden min-h-0 w-80 shrink-0 flex-col border-l border-slate-200/70 bg-slate-100",
    "dark:border-stone-800 dark:bg-stone-950 xl:flex",
  ),
  panel: clsx(
    "rounded-lg border border-slate-200 bg-white/90 shadow-[0_4px_12px_rgba(18,38,63,0.03)]",
    "dark:border-stone-800 dark:bg-stone-900",
  ),
  secondaryPanel: clsx(
    "rounded-lg border border-slate-200/80 bg-slate-50/85 shadow-[0_4px_12px_rgba(18,38,63,0.02)]",
  ...
  statusTile: clsx("rounded-md bg-white p-3", "dark:bg-stone-950/70"),
