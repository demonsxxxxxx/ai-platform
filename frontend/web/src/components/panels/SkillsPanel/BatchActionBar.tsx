...
export function BatchActionBar({
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 z-40 flex justify-center sm:bottom-6 sm:left-1/2 sm:right-auto sm:-translate-x-1/2">
      <div className="flex items-center gap-1 rounded-lg border border-[var(--theme-border)] bg-[var(--theme-bg)] px-2 py-1.5 shadow-xl shadow-black/8 dark:shadow-black/24">
