  ...
  return (
    <div className={workbenchSurface.catalog.cardGrid}>
      {sources.map((source) => {
        ...
        const aclRuleCount =
          source.allowed_department_ids.length +
          source.allowed_roles.length +
          source.allowed_user_ids.length;
        const aclReady = source.visibility === "enterprise" || aclRuleCount > 0;
        return (
