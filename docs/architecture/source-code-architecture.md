...
the immutable admitted model ID, upstream value, and connection revision
snapshot, including Copy/Retry/Resume inheritance, through its public
application API on the caller's existing transaction. General Harness
