...
- **Bounded paths:** `app/conversations/application/submission_resolution.py`, `app/conversations/transport/submission.py`, `app/conversations/api.py`, the legacy Chat compatibility imports/delegation, `frontend/web/src/hooks/useAgent.ts`, `frontend/web/src/hooks/useAgent/sseConnection.ts`, their owning tests, and this contract.
