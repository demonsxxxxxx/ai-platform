...
| --- | --- | --- | --- | --- |
| 2026-06-12 | Foundation Alpha POC | `b96d02e232176bade455f2af2bc3080f8f372206` | [`2026-06-12-211-foundation-alpha-poc-b96d02e-release-evidence-runtime-acceptance.json`](foundation-alpha-poc/b96d02e232176bade455f2af2bc3080f8f372206/2026-06-12-211-foundation-alpha-poc-b96d02e-release-evidence-runtime-acceptance.json) | Active 211 release-evidence runtime acceptance passed inside `ai-platform:b96d02e-release-evidence-runtime-acceptance`; supports removing the G9 runtime export/retention acceptance blocker for this runtime subject but does not close alert/trace export, SBOM, frontend image, or production gates. |
| 2026-06-12 | Foundation Alpha POC | `b96d02e232176bade455f2af2bc3080f8f372206` | [`2026-06-12-211-foundation-alpha-poc-b96d02e-governance-runtime-smoke.json`](foundation-alpha-poc/b96d02e232176bade455f2af2bc3080f8f372206/2026-06-12-211-foundation-alpha-poc-b96d02e-governance-runtime-smoke.json) | Active 211 Admin Runtime governance smoke passed against `ai-platform:b96d02e-release-evidence-runtime-acceptance`; supports the current POC runtime but does not close G6 or production governance rollout. |
| 2026-06-12 | Foundation Alpha POC | `b96d02e232176bade455f2af2bc3080f8f372206` | [`2026-06-12-211-foundation-alpha-poc-b96d02e-auth-rbac-smoke.json`](foundation-alpha-poc/b96d02e232176bade455f2af2bc3080f8f372206/2026-06-12-211-foundation-alpha-poc-b96d02e-auth-rbac-smoke.json) | Active 211 Auth/RBAC smoke passed against `ai-platform:b96d02e-release-evidence-runtime-acceptance`; not production gate closure. |
| 2026-06-12 | Foundation Alpha POC | `b96d02e232176bade455f2af2bc3080f8f372206` | [`2026-06-12-211-foundation-alpha-poc-b96d02e-runtime-poc-smoke.json`](foundation-alpha-poc/b96d02e232176bade455f2af2bc3080f8f372206/2026-06-12-211-foundation-alpha-poc-b96d02e-runtime-poc-smoke.json) | Active 211 runtime smoke passed for the controlled context public projection and release-evidence-runtime-acceptance rollout slice; context public projection returned `summary_source=chat_stream` and safe `input_keys=["attachments","message"]`; not production closure. |
...
The 2026-06-12 `b96d02e` 211 evidence records reviewed runtime export and
retention acceptance for the active Foundation Alpha POC runtime subject. This
removes the narrower `g9_runtime_export_and_retention_acceptance` blocker for
that runtime subject. It does not close G9 or Foundation Alpha by itself:
alert/trace export acceptance, signed Skill package or SBOM review evidence,
ordinary-user legacy-route acceptance, packaged frontend image release
acceptance, review/PR closure, and the broader auth/session/RBAC regression
gates remain separate blockers.
