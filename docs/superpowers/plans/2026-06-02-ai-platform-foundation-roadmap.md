...
claims require pinned snapshot binding samples. The 2026-06-14 `384474c` 211
rerun now verifies the Foundation Runtime concurrency evidence requirements,
including queue/admission, sandbox lease, memory scope, and skill binding
samples. This gate does not open ordinary-user multi-agent, does not claim
Docker sandbox hardening, does not raise production concurrency defaults, and
