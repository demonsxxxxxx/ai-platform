...
close G9: `release_evidence_runtime_export_acceptance` and
`release_evidence_retention_policy` remain open until runtime export
acceptance, retention policy, review workflow, and deployment evidence are
proven.
