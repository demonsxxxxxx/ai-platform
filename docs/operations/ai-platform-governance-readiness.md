...
`tools/b1_memory_context_readiness.py`; the 2026-06-19 #128 refresh records
reviewed B1 smoke evidence for runtime subject
`87528bf30609092c3c4e947bdca477768af3f8e5`, and the readiness classifier
reports no runtime-affecting delta from that subject to current source
`5cfe9569e9e0770869c6f9bfa1e6702d03ce563b`. That closes only
...
the recorded `87528bf` B1 smoke, the readiness output must reopen that boundary
...
governed document workflow slice only. The #128 smoke reused the running
`ai-platform:87528bf-issue124-runtime-only-v2` runtime and records the caveat
