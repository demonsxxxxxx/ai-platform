...
frontend context provenance acceptance, quarantined inactive legacy source remap,
...
context-pack persistence/versioning, but still needs 211 executor context-pack
acceptance, document-centric follow-up state, execution-tier routing, sandbox
...
generated time rather than raw message/file/artifact/memory IDs. The
