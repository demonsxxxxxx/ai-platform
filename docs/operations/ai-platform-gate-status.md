...
After PR #199 merged into `main` at
`17dc3ae111cd1538fcf1412558d9d19b93f5b918`, #164 received a 211 runtime and
evidence refresh for that runtime subject on 2026-06-24. The 211 API and worker
run image `ai-platform:17dc3ae-issue164-post-pr199-runtime-only-v1` with image ID
`sha256:97cb1c15b96b46da99049b8d9ef79c11605769651c1f1d8f3e7b08847e7d7259`.
The runtime source marker, runtime subject, OCI revision label,
hyphen/underscore source revision labels, and `/api/ai/health` align to
`17dc3ae`. The official B0 smoke used a 420s word-review wait and produced
`ok=true`, governed Skill snapshots for `baoyu-translate` and
`qa-file-reviewer`, a succeeded `word_review_attachment_chat` run with reviewed
...
Foundation Runtime concurrency refresh for the same `17dc3ae` runtime subject
...
named `17dc3ae` runtime subject only. Docker sandbox hardening, ordinary-user
...
The full 17dc3ae #164 runtime-subject B0 POC smoke refresh includes reviewed,
redacted entries for runtime POC smoke, Auth/RBAC smoke, Admin Runtime
governance smoke, release-evidence runtime acceptance, and alert/trace export
runtime acceptance:
`docs/release-evidence/foundation-alpha-poc/17dc3ae111cd1538fcf1412558d9d19b93f5b918/2026-06-24-211-foundation-alpha-poc-17dc3ae-runtime-poc-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/17dc3ae111cd1538fcf1412558d9d19b93f5b918/2026-06-24-211-foundation-alpha-poc-17dc3ae-auth-rbac-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/17dc3ae111cd1538fcf1412558d9d19b93f5b918/2026-06-24-211-foundation-alpha-poc-17dc3ae-governance-runtime-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/17dc3ae111cd1538fcf1412558d9d19b93f5b918/2026-06-24-211-foundation-alpha-poc-17dc3ae-release-evidence-runtime-acceptance.json`, and
`docs/release-evidence/foundation-alpha-poc/17dc3ae111cd1538fcf1412558d9d19b93f5b918/2026-06-24-211-foundation-alpha-poc-17dc3ae-alert-trace-export-runtime-acceptance.json`.
The paired Foundation Runtime concurrency entries are
`docs/release-evidence/foundation-runtime-concurrency/17dc3ae111cd1538fcf1412558d9d19b93f5b918-frc-b0-20260624/2026-06-24-17dc3ae-foundation-runtime-concurrency.json`
and
`docs/release-evidence/foundation-runtime-concurrency/17dc3ae111cd1538fcf1412558d9d19b93f5b918-frc-b0-20260624/2026-06-24-17dc3ae-foundation-runtime-concurrency-readiness.json`.
...
only when the current source has no runtime-affecting delta after the `17dc3ae`
...
evidence is recorded. The prior 0a9e70a, a4bded0, 2bc3a35, d94d274, dab7dbc,
...
baseline, the `17dc3ae` / #164 evidence is the latest reviewed runtime-subject
reference, and the `0a9e70a`, `df85a9f`, `a4bded0`, `2bc3a35`, `d94d274`, `dab7dbc`,
...
| G9 Observability / Quality / Ops | Reviewed release-evidence runtime acceptance and alert/trace runtime acceptance exist for `17dc3ae`; G9 remains partial for Operations Beta. | Admin Runtime overview, capacity/governance/observability readiness docs and tools, error taxonomy/dashboard contracts, release-evidence contracts, reviewed 211 release-evidence runtime export/retention acceptance for `17dc3ae`, reviewed 211 alert/trace export runtime acceptance for `17dc3ae`, superseded `0a9e70a`, superseded `df85a9f`, superseded `a4bded0`, `2bc3a35`, `d94d274`, `dab7dbc`, `4039e4b`, and `87528bf` G9 runtime evidence, trace/audit export contracts, frontend projection audit, and reviewed 211 POC smoke entry. | S2/G9 closure still requires runtime dashboard acceptance, recorded capacity evidence, model-gateway backpressure evidence, golden-set eval runtime, alert delivery enablement/runtime calibration, and remaining Admin Runtime observability follow-ups. |
