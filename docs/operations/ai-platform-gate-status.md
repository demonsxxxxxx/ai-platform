...
FRC/status-upgrade blockers for `945db2b`, but all seven recorded load-test
gates and the `b3_10x4_sdk_subagents` profile evidence are still missing.
...
because B3 load/profile evidence remains missing. The prior `a294727`,
