...
`40691c01d64d6cd604dd94e6fc24ee6babdf0cad`, while 211 still runs the PR #308
runtime subject `15903fdfe96ffcfba9daa1252741111017dcf832`. Current status must
therefore be read as PR #311 merged source/docs/audit-boundary progress layered
on top of the deployed PR #308 label-clean runtime evidence, plus earlier
reviewed `9c669761`, `decf33a`, `4805031`, `ae6b7e5`, and `28676df` evidence.
It is not gate closure. PR #311 is merged source/docs/audit-boundary progress,
not a 211 rollout for `40691c01d64d6cd604dd94e6fc24ee6babdf0cad`, and it does
not make current `main` `211 verified`.
...
evidence. PR #311 does not change that runtime-subject boundary until a future
211 rollout and smoke bind `40691c01d64d6cd604dd94e6fc24ee6babdf0cad` to the
running backend/worker image and source marker.
