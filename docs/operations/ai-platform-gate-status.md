...
After PR #202 merged into `main` at
`e7558cc6a86a378ee747eb02ae9a4496ca40041a`, #164 received a 211 runtime and
evidence refresh for that runtime subject on 2026-06-24. The 211 API and worker
run image `ai-platform:e7558cc-issue164-current-main-runtime-only-v2` with image ID
`sha256:f52fd75021ba0cc4ff169f67650bcbfdd95eee5a8c843b15e4862884c166c056`.
The runtime source marker, runtime subject, OCI revision label,
hyphen/underscore source revision labels, and `/api/ai/health` align to
`e7558cc`. The official B0 smoke used a 420s word-review wait and produced
`ok=true`, governed Skill snapshots for `baoyu-translate` and
`qa-file-reviewer`, a succeeded `word_review_attachment_chat` run with reviewed
DOCX/report evidence, upload attachment worker-start evidence, context public
...
Foundation Runtime concurrency refresh for the same `e7558cc` runtime subject
verified 12 concurrent requests/sessions/runs across 2 tenants and 4 users
after the formal rerun used a 1200s per-run timeout. It covered run creation,
execution, cancel, retry, queue/admission, sandbox workspace, memory/context,
artifact ACL, tool permission, skill snapshots, playback, fixture preparation,
...
named `e7558cc` runtime subject only. Docker sandbox hardening, ordinary-user
...
The full e7558cc #164 runtime-subject B0 POC smoke refresh includes reviewed,
redacted entries for runtime POC smoke, Auth/RBAC smoke, Admin Runtime
governance smoke, release-evidence runtime acceptance, and alert/trace export
runtime acceptance:
`docs/release-evidence/foundation-alpha-poc/e7558cc6a86a378ee747eb02ae9a4496ca40041a/2026-06-24-211-foundation-alpha-poc-e7558cc-runtime-poc-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/e7558cc6a86a378ee747eb02ae9a4496ca40041a/2026-06-24-211-foundation-alpha-poc-e7558cc-auth-rbac-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/e7558cc6a86a378ee747eb02ae9a4496ca40041a/2026-06-24-211-foundation-alpha-poc-e7558cc-governance-runtime-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/e7558cc6a86a378ee747eb02ae9a4496ca40041a/2026-06-24-211-foundation-alpha-poc-e7558cc-release-evidence-runtime-acceptance.json`, and
`docs/release-evidence/foundation-alpha-poc/e7558cc6a86a378ee747eb02ae9a4496ca40041a/2026-06-24-211-foundation-alpha-poc-e7558cc-alert-trace-export-runtime-acceptance.json`.
The paired Foundation Runtime concurrency entries are
`docs/release-evidence/foundation-runtime-concurrency/e7558cc6a86a378ee747eb02ae9a4496ca40041a-frc-b0-20260624/2026-06-24-e7558cc-foundation-runtime-concurrency.json`
and
`docs/release-evidence/foundation-runtime-concurrency/e7558cc6a86a378ee747eb02ae9a4496ca40041a-frc-b0-20260624/2026-06-24-e7558cc-foundation-runtime-concurrency-readiness.json`.
...
only when the current source has no runtime-affecting delta after the `e7558cc`
source-runtime relation manifest and #164 evidence. After later runtime-affecting
source changes merge into `main`, readiness must instead report a
runtime rollout requirement such as `source_synced_runtime_pending` /
`runtime_rollout_required` until fresh current-source or runtime-relevant
evidence is recorded. The prior 17dc3ae, 0a9e70a, a4bded0, 2bc3a35, d94d274, dab7dbc,
4039e4b, 87528bf, 75ab69b, and #112/#124/#138 evidence are retained as superseded
reviewed history and must not be used for current B0 latest-main claims after
newer runtime-affecting source changes.
...
baseline, the `e7558cc` / #164 evidence is the latest reviewed runtime-subject
reference, and the `17dc3ae`, `0a9e70a`, `df85a9f`, `a4bded0`, `2bc3a35`, `d94d274`, `dab7dbc`,
`4039e4b`, `87528bf`, `75ab69b`, `79495bf`, `dff48fb`, and `ac9a86b` evidence is now
retained as superseded reviewed history. The #164 runtime-subject evidence scope still carries G0
...
| --- | --- | --- | --- |
| G0-G1 Source Authority / Security Baseline | #164 records reviewed B0 runtime-subject evidence for `e7558cc`; the source snapshot marker, runtime subject, runtime source marker, OCI revision label, hyphen/underscore source revision labels, API/worker health, and named runtime-subject evidence are recorded for that runtime subject. Later runtime-affecting source changes require a fresh rollout before any current-source verification claim. G0 source-authority closure remains blocked by the external env-file label caveat and production auth rollout evidence. | PRD v2, backend phased PRD, technical acceptance matrix, roadmap, guardrails, source-authority tests, repo-local compose context, frontend source migration, redacted deploy templates, 2026-06-24 `e7558cc` POC release evidence, 2026-06-24 `e7558cc` Foundation Runtime concurrency evidence, superseded 2026-06-24 `17dc3ae` POC release evidence, superseded 2026-06-24 `17dc3ae` Foundation Runtime concurrency evidence, superseded 2026-06-23 `0a9e70a` POC release evidence, superseded 2026-06-23 `0a9e70a` Foundation Runtime concurrency evidence, superseded 2026-06-23 `df85a9f` POC release evidence, superseded 2026-06-23 `df85a9f` Foundation Runtime concurrency evidence, superseded 2026-06-23 `a4bded0` POC release evidence, superseded 2026-06-23 `a4bded0` Foundation Runtime concurrency evidence, superseded 2026-06-22 `2bc3a35` POC release evidence, superseded 2026-06-22 `2bc3a35` Foundation Runtime concurrency evidence, superseded 2026-06-22 `d94d274` POC release evidence, superseded 2026-06-22 `d94d274` Foundation Runtime concurrency evidence, superseded 2026-06-22 `dab7dbc` POC release evidence, superseded 2026-06-22 `dab7dbc` Foundation Runtime concurrency evidence, superseded 2026-06-20 `4039e4b` evidence, superseded 2026-06-19 `87528bf` evidence, superseded 2026-06-19 `75ab69b` evidence, superseded 2026-06-19 `dde1749` evidence, superseded 2026-06-19 `14808bc` evidence, superseded 2026-06-18 `5698873` evidence, superseded 2026-06-18 `de12191` evidence, superseded 2026-06-17 `a15c74f` evidence, superseded 2026-06-16 `8e0389e` evidence, 2026-06-15 `380de6b` historical baseline evidence, and issue #164 evidence. | Reconcile the external env-file label caveat, record production auth rollout evidence, and refresh B0 again after any runtime-affecting source change before any G0 closure claim. |
...
| G5 Run Lifecycle / Worker Runtime V1 | Foundation Alpha POC verified queue/run/worker execution and Admin capacity/backpressure projection exist; #164 Foundation Runtime concurrency evidence exists for the `e7558cc` runtime subject, but this is not capacity-closed and does not raise defaults. | Tenant-aware queue lease, worker maintenance, active-run admission, bounded metadata, Admin Runtime capacity/backpressure projection, #20 roadmap closure notes, 2026-06-24 `e7558cc` POC verifier evidence, 2026-06-24 `e7558cc` verified Foundation Runtime concurrency evidence, superseded 2026-06-24 `17dc3ae` POC verifier evidence, superseded 2026-06-24 `17dc3ae` verified Foundation Runtime concurrency evidence, superseded 2026-06-23 `0a9e70a` POC verifier evidence, superseded 2026-06-23 `0a9e70a` verified Foundation Runtime concurrency evidence, superseded 2026-06-23 `df85a9f` POC verifier evidence, superseded 2026-06-23 `df85a9f` verified Foundation Runtime concurrency evidence, superseded 2026-06-23 `a4bded0` POC verifier evidence, superseded 2026-06-23 `a4bded0` verified Foundation Runtime concurrency evidence, superseded 2026-06-22 `2bc3a35` POC verifier evidence, superseded 2026-06-22 `2bc3a35` verified Foundation Runtime concurrency evidence, superseded 2026-06-22 `d94d274` POC verifier evidence, superseded 2026-06-22 `d94d274` verified Foundation Runtime concurrency evidence, superseded 2026-06-22 `dab7dbc` POC verifier evidence, superseded 2026-06-22 `dab7dbc` verified Foundation Runtime concurrency evidence, superseded 2026-06-20 `4039e4b` POC verifier evidence, superseded 2026-06-20 `4039e4b` verified Foundation Runtime concurrency evidence, superseded 2026-06-19 `87528bf` POC verifier evidence, superseded 2026-06-19 `87528bf` verified Foundation Runtime concurrency evidence, superseded 2026-06-19 `75ab69b` POC verifier evidence, superseded 2026-06-19 `75ab69b` verified Foundation Runtime concurrency evidence, superseded 2026-06-19 `dde1749` POC verifier evidence, superseded 2026-06-19 `dde1749` verified Foundation Runtime concurrency evidence, superseded 2026-06-19 `14808bc` POC verifier evidence, superseded 2026-06-19 `14808bc` verified Foundation Runtime concurrency evidence, superseded 2026-06-19 `14808bc` 240s blocked FRC diagnostic, superseded 2026-06-18 `5698873` evidence, superseded 2026-06-18 `de12191` evidence, superseded 2026-06-17 `a15c74f` evidence, superseded 2026-06-16 `8e0389e` failed-closed FRC diagnostics, superseded 2026-06-17 `8e0389e` verified Foundation Runtime concurrency evidence, and 2026-06-15 `380de6b` historical accepted concurrency evidence. | Keep #21/B3 capacity evidence, large queue bounded lookup pressure, worker parallelism/capacity profiling, and multi-tenant load evidence separate from #164. #21 is currently closed in GitHub but the B3 capacity evidence remains incomplete. Production defaults stay unchanged. |
...
| G9 Observability / Quality / Ops | Reviewed release-evidence runtime acceptance and alert/trace runtime acceptance exist for `e7558cc`; G9 remains partial for Operations Beta. | Admin Runtime overview, capacity/governance/observability readiness docs and tools, error taxonomy/dashboard contracts, release-evidence contracts, reviewed 211 release-evidence runtime export/retention acceptance for `e7558cc`, reviewed 211 alert/trace export runtime acceptance for `e7558cc`, superseded `17dc3ae`, superseded `0a9e70a`, superseded `df85a9f`, superseded `a4bded0`, `2bc3a35`, `d94d274`, `dab7dbc`, `4039e4b`, and `87528bf` G9 runtime evidence, trace/audit export contracts, frontend projection audit, and reviewed 211 POC smoke entry. | S2/G9 closure still requires runtime dashboard acceptance, recorded capacity evidence, model-gateway backpressure evidence, golden-set eval runtime, alert delivery enablement/runtime calibration, and remaining Admin Runtime observability follow-ups. |
