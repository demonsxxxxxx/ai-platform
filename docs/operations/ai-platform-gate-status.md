...
After PR #196 merged into `main` at
`0a9e70a41f2e86afce2be2294b21d2f5651d448d`, #164 received a 211 runtime and
evidence refresh for that runtime subject on 2026-06-23. The 211 API and worker
run image `ai-platform:0a9e70a-issue164-b0-label-fix-runtime-only-v1` with image ID
`sha256:1aa734e4b316c0653257de4ed5e44132ea1a941d9b26851de161ff451d256bc1`.
The runtime source marker, runtime subject, OCI revision label,
hyphen/underscore source revision labels, and `/api/ai/health` align to
`0a9e70a`. The official B0 smoke used a 420s word-review wait and produced
`ok=true`, governed Skill snapshots for `baoyu-translate` and
`qa-file-reviewer`, a succeeded `word_review_attachment_chat` run with reviewed
DOCX evidence, upload attachment worker-start evidence, context public
projection, and no private projection leaks. Auth/RBAC, Admin Runtime
...
Foundation Runtime concurrency refresh for the same `0a9e70a` runtime subject
...
named `0a9e70a` runtime subject only. The separate
`ordinary_user_acceptance_for_quarantined_legacy_routes` follow-up remains open
alongside Docker sandbox hardening, ordinary-user multi-agent exposure, and B3
capacity evidence. This is controlled B0 runtime evidence only: it does not make
#164 `gate closable`, does not close G0 source authority, does not close B1/B2/B3
product gates, does not raise production concurrency defaults, does not claim
Docker sandbox hardening, and does not enable ordinary-user multi-agent exposure.
...
The full 0a9e70a #164 runtime-subject B0 POC smoke refresh includes reviewed,
redacted entries for runtime POC smoke, Auth/RBAC smoke, Admin Runtime
governance smoke, release-evidence runtime acceptance, and alert/trace export
runtime acceptance:
`docs/release-evidence/foundation-alpha-poc/0a9e70a41f2e86afce2be2294b21d2f5651d448d/2026-06-23-211-foundation-alpha-poc-0a9e70a-runtime-poc-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/0a9e70a41f2e86afce2be2294b21d2f5651d448d/2026-06-23-211-foundation-alpha-poc-0a9e70a-auth-rbac-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/0a9e70a41f2e86afce2be2294b21d2f5651d448d/2026-06-23-211-foundation-alpha-poc-0a9e70a-governance-runtime-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/0a9e70a41f2e86afce2be2294b21d2f5651d448d/2026-06-23-211-foundation-alpha-poc-0a9e70a-release-evidence-runtime-acceptance.json`, and
`docs/release-evidence/foundation-alpha-poc/0a9e70a41f2e86afce2be2294b21d2f5651d448d/2026-06-23-211-foundation-alpha-poc-0a9e70a-alert-trace-export-runtime-acceptance.json`.
The paired Foundation Runtime concurrency entries are
`docs/release-evidence/foundation-runtime-concurrency/0a9e70a41f2e86afce2be2294b21d2f5651d448d-frc-b0-20260623/2026-06-23-0a9e70a-foundation-runtime-concurrency.json`
and
`docs/release-evidence/foundation-runtime-concurrency/0a9e70a41f2e86afce2be2294b21d2f5651d448d-frc-b0-20260623/2026-06-23-0a9e70a-foundation-runtime-concurrency-readiness.json`.
...
only when the current source has no runtime-affecting delta after the `0a9e70a`
...
evidence is recorded. The prior a4bded0, 2bc3a35, d94d274, dab7dbc, 4039e4b,
87528bf, 75ab69b, and #112/#124/#138 evidence are retained as superseded
...
baseline, the `0a9e70a` / #164 evidence is the latest reviewed runtime-subject
reference, and the `df85a9f`, `a4bded0`, `2bc3a35`, `d94d274`, `dab7dbc`, `4039e4b`,
`87528bf`, `75ab69b`, `79495bf`, `dff48fb`, and `ac9a86b` evidence is now
...
| G9 Observability / Quality / Ops | Reviewed release-evidence runtime acceptance and alert/trace runtime acceptance exist for `0a9e70a`; G9 remains partial for Operations Beta. | Admin Runtime overview, capacity/governance/observability readiness docs and tools, error taxonomy/dashboard contracts, release-evidence contracts, reviewed 211 release-evidence runtime export/retention acceptance for `0a9e70a`, reviewed 211 alert/trace export runtime acceptance for `0a9e70a`, superseded `df85a9f`, superseded `a4bded0`, `2bc3a35`, `d94d274`, `dab7dbc`, `4039e4b`, and `87528bf` G9 runtime evidence, trace/audit export contracts, frontend projection audit, and reviewed 211 POC smoke entry. | S2/G9 closure still requires runtime dashboard acceptance, recorded capacity evidence, model-gateway backpressure evidence, golden-set eval runtime, alert delivery enablement/runtime calibration, and remaining Admin Runtime observability follow-ups. |
