...
callback exception path, leaving required callback evidence absent. The pushed
source/test branch `codex/g8-b3-status-refresh` now fixes the 211 sandbox
