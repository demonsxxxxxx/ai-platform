...
subject is `3c5b9f0241fc48d8749dcbad14a0dce63368074a`. On 2026-06-15, source
and API/worker were advanced to that commit with runtime-only image
`ai-platform:3c5b9f0-foundation-alpha-current-source` and image ID
`sha256:1d80e33dec6a519ec2d7e1056ad3ed4ddc87029a9b0cad8d49ce31cb4e632af8`.
...
label point to `3c5b9f0`; API health returned `ok`; container compile checks
passed; and compose labels point to the repo-local deploy composition. Compose
still uses an existing external runtime env file through `--env-file` without
copying or printing values, so this evidence does not by itself close
production or G0 deployment-layout follow-ups.
...
The full 3c5b9f0 POC evidence refresh includes reviewed, redacted entries for
...
`docs/release-evidence/foundation-alpha-poc/3c5b9f0241fc48d8749dcbad14a0dce63368074a/2026-06-15-211-foundation-alpha-poc-3c5b9f0-runtime-poc-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/3c5b9f0241fc48d8749dcbad14a0dce63368074a/2026-06-15-211-foundation-alpha-poc-3c5b9f0-auth-rbac-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/3c5b9f0241fc48d8749dcbad14a0dce63368074a/2026-06-15-211-foundation-alpha-poc-3c5b9f0-governance-runtime-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/3c5b9f0241fc48d8749dcbad14a0dce63368074a/2026-06-15-211-foundation-alpha-poc-3c5b9f0-release-evidence-runtime-acceptance.json`,
`docs/release-evidence/foundation-alpha-poc/3c5b9f0241fc48d8749dcbad14a0dce63368074a/2026-06-15-211-foundation-alpha-poc-3c5b9f0-alert-trace-export-runtime-acceptance.json`, and
`docs/release-evidence/foundation-runtime-concurrency/3c5b9f0241fc48d8749dcbad14a0dce63368074a-frc-current-source-20260615/2026-06-15-211-foundation-alpha-poc-3c5b9f0-foundation-runtime-concurrency.json`.
This refresh verifies the controlled POC loop and cross-user/cross-tenant
artifact download and preview denial for the 3c5b9f0 runtime subject. The local
...
`ordinary_company_login_audit_count=13`, and
`admin_company_login_audit_count=38`. It keeps
`ordinary_user_multi_agent_allowed=false`, `production_claim_allowed=false`,
`docker_sandbox_hardened_claim_allowed=false`, and
...
The prior `79495bf` broad POC and Foundation Runtime concurrency refresh is
retained as historical Foundation Alpha POC evidence after the 3c5b9f0
current-source refresh superseded it:
`docs/release-evidence/foundation-alpha-poc/79495bf4954017351db6d19494a16099fe2ee0bf/2026-06-14-211-foundation-alpha-poc-79495bf-runtime-poc-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/79495bf4954017351db6d19494a16099fe2ee0bf/2026-06-14-211-foundation-alpha-poc-79495bf-auth-rbac-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/79495bf4954017351db6d19494a16099fe2ee0bf/2026-06-14-211-foundation-alpha-poc-79495bf-governance-runtime-smoke.json`,
`docs/release-evidence/foundation-alpha-poc/79495bf4954017351db6d19494a16099fe2ee0bf/2026-06-14-211-foundation-alpha-poc-79495bf-release-evidence-runtime-acceptance.json`,
`docs/release-evidence/foundation-alpha-poc/79495bf4954017351db6d19494a16099fe2ee0bf/2026-06-14-211-foundation-alpha-poc-79495bf-alert-trace-export-runtime-acceptance.json`, and
`docs/release-evidence/foundation-runtime-concurrency/79495bf4954017351db6d19494a16099fe2ee0bf-frc-pr40-20260614/2026-06-14-211-foundation-alpha-poc-79495bf-foundation-runtime-concurrency.json`.

The prior `dff48fb` broad POC evidence refresh is retained as historical
Foundation Alpha POC evidence after the 79495bf broad refresh superseded it:
...
PR #40 rerun is retained as superseded reviewed evidence after the 3c5b9f0
current-source refresh. The 2026-06-15 `3c5b9f0` rerun is the current accepted
...
48 denied negative tool-permission reuse probes. This closes only the PR #40
Foundation Runtime concurrency evidence gap for the `3c5b9f0` runtime-relevant
...
evidence only; the `3c5b9f0` evidence above is the active Foundation Alpha POC
reference, while the `79495bf`, `dff48fb`, and `ac9a86b` evidence is now
retained as superseded reviewed history.
