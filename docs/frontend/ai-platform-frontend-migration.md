...
- #22 document-centric context/workbench UX now has a source-level architecture
  ...
  source-level execution-tier routing and bounded executor context-pack prompt
  injection tests, but
