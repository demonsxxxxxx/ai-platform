    ...
    *,
    ...
    cursor = await conn.execute(
        ...
        select agent_profile_revisions.tenant_id, agent_profile_revisions.agent_id,
               ...
               agent_profile_revisions.supported_input_types, agent_profile_revisions.legacy_supported_file_types,
    ...
    *,
    ...
    cursor = await conn.execute(
        ...
        select tenant_id, agent_id, revision, revision_status as status, name, description,
               ...
               supported_input_types, legacy_supported_file_types, expected_outputs,
