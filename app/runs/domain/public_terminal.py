...
PUBLIC_TERMINAL_DETAIL_MESSAGES = {
    ...
    "model_proxy_configuration_invalid": "模型运行配置不可用。请联系管理员确认模型代理配置。",
...
PUBLIC_TERMINAL_ERROR_CODE_ALIASES = {
    ...
    "model_proxy_path_not_allowed": "model_proxy_authorization_failed",
    "model_proxy_query_not_allowed": "model_proxy_authorization_failed",
    "model_proxy_header_duplicate": "model_proxy_authorization_failed",
    "model_proxy_anthropic_version_not_allowed": "model_proxy_authorization_failed",
    "model_proxy_anthropic_beta_not_allowed": "model_proxy_authorization_failed",
    "model_proxy_run_binding_invalid": "model_proxy_run_binding_failed",
    "model_capacity_missing": "model_proxy_configuration_invalid",
    "model_proxy_conversation_mode_invalid": "model_proxy_configuration_invalid",
    "model_proxy_body_invalid": "model_proxy_configuration_invalid",
    "model_proxy_max_tokens_invalid": "model_proxy_configuration_invalid",
    "model_proxy_count_tokens_failed": "model_service_unavailable",
    "model_proxy_count_tokens_unavailable": "model_service_unavailable",
    "model_proxy_count_tokens_invalid": "model_service_unavailable",
