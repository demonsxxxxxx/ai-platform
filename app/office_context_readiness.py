...
def build_office_context_readiness() -> dict[str, Any]:
    ...
    return {
        ...
        "evidence_policy": (
            "This records source-level context-pack contract, persistence/versioning, and "
            "executor prompt-injection tests; 211 executor smoke, frontend acceptance, and "
            "document-centric follow-up state are still required before office context continuity "
            "can close G6/G9."
        ),
    }
