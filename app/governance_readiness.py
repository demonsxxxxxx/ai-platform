    ...
    domains = {
        ...
        "frontend_projection": _domain(
            implemented=[
                ...
                "legacy_model_admin_client_retired",
            ...
            gaps=[
                "ordinary_user_g9_acceptance_for_active_envvar_and_roles_routes",
                "inactive_legacy_channel_and_admin_sources_need_policy_or_projection_remap",
                "frontend_packaged_image_delivery_and_release_acceptance",
            ],
            next_checks=[
                "policy-gate or remap active /api/env-vars and /api/roles routes before ordinary-user G9 acceptance",
                "remove, remap, or keep fail-closed the remaining inactive channel/admin compatibility sources before release",
