...
EXTERNAL_KNOWLEDGE_SCHEMA_VERSION = "2026.09.19.1"
...
CRITICAL_COLUMNS = (
    ...
    ("knowledge_retrieval_profiles", "revision", "int8", True),
    ("knowledge_retrieval_profiles", "mode", "text", True),
    ("knowledge_retrieval_profiles", "top_k_per_source", "int4", True),
    ("knowledge_retrieval_profiles", "candidate_pool_size", "int4", True),
    ("knowledge_retrieval_profiles", "score_threshold", "float8", True),
    ("knowledge_retrieval_profiles", "overall_timeout_ms", "int4", True),
    ("knowledge_retrieval_profiles", "max_total_evidence_bytes", "int4", True),
    ("knowledge_retrieval_profiles", "status", "text", True),
    ("knowledge_retrieval_profiles", "content_hash", "text", True),
    ("run_knowledge_snapshots", "run_id", "text", True),
    ("run_knowledge_snapshots", "agent_id", "text", True),
    ("run_knowledge_snapshots", "profile_revision", "int8", True),
    ("run_knowledge_snapshots", "profile_content_hash", "text", True),
    ("run_knowledge_snapshots", "retrieval_profile_id", "text", True),
    ("run_knowledge_snapshots", "retrieval_profile_revision", "int8", True),
    ("run_knowledge_snapshots", "sources_json", "jsonb", True),
    ("run_knowledge_snapshots", "principal_policy_version", "int4", True),
    ("run_knowledge_snapshots", "authorized_at", "timestamptz", True),
    ("run_knowledge_snapshots", "content_hash", "text", True),
    ("knowledge_retrieval_attempts", "run_id", "text", True),
    ("knowledge_retrieval_attempts", "attempt_id", "text", True),
    ("knowledge_retrieval_attempts", "generation", "int8", True),
    ("knowledge_retrieval_attempts", "snapshot_hash", "text", True),
    ("knowledge_retrieval_attempts", "status", "text", True),
    ("knowledge_retrieval_attempts", "source_count", "int4", True),
    ("knowledge_retrieval_attempts", "result_count", "int4", True),
    ("knowledge_retrieval_attempts", "evidence_count", "int4", True),
    ("knowledge_retrieval_attempts", "provider_retry_count", "int4", True),
    ("knowledge_retrieval_attempts", "duration_ms", "int4", False),
    ("knowledge_retrieval_attempts", "safe_failure_code", "text", False),
    ("knowledge_retrieval_attempts", "cancel_requested_at", "timestamptz", False),
    ("knowledge_retrieval_attempts", "terminal_digest", "text", False),
    ("knowledge_retrieval_attempts", "started_at", "timestamptz", False),
    ("knowledge_retrieval_attempts", "deadline_at", "timestamptz", False),
    ("knowledge_retrieval_attempts", "completed_at", "timestamptz", False),
    ("knowledge_evidence", "retrieval_attempt_id", "text", True),
    ("knowledge_evidence", "evidence_id", "text", True),
    ("knowledge_evidence", "source_id", "text", True),
    ("knowledge_evidence", "provider_document_id", "text", True),
    ("knowledge_evidence", "provider_chunk_id", "text", False),
    ("knowledge_evidence", "title", "text", True),
    ("knowledge_evidence", "content", "text", True),
    ("knowledge_evidence", "content_sha256", "text", True),
    ("knowledge_evidence", "provider_score", "float8", True),
    ("knowledge_evidence", "fused_rank", "int4", True),
    ("knowledge_evidence", "position_json", "jsonb", True),
    ("knowledge_citations", "message_id", "text", True),
    ("knowledge_citations", "retrieval_attempt_id", "text", True),
    ("knowledge_citations", "retrieval_generation", "int8", True),
    ("knowledge_citations", "evidence_id", "text", True),
    ("knowledge_citations", "ordinal", "int4", True),
    ("knowledge_citations", "source_id", "text", True),
    ("knowledge_citations", "document_ref", "text", True),
    ("knowledge_citations", "chunk_ref", "text", False),
    ("knowledge_citations", "title", "text", True),
    ("knowledge_citations", "excerpt", "text", True),
    ("knowledge_citations", "content_sha256", "text", True),
    ("knowledge_citations", "score", "float8", True),
    ("knowledge_citations", "position_json", "jsonb", True),
    ("knowledge_citations", "operation_id", "text", True),
    ("knowledge_citations", "citation_set_hash", "text", True),
...
CRITICAL_CONSTRAINTS = (
    ...
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_identity"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_name"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_mode"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_result_bounds"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_time_bounds"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_retry_bounds"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_budget_bounds"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_status"),
    ("knowledge_retrieval_profiles", "chk_knowledge_retrieval_profile_hash"),
    ("run_knowledge_snapshots", "fk_run_knowledge_snapshot_run"),
    ("run_knowledge_snapshots", "fk_run_knowledge_snapshot_agent_profile"),
    ("run_knowledge_snapshots", "fk_run_knowledge_snapshot_retrieval_profile"),
    ("run_knowledge_snapshots", "chk_run_knowledge_snapshot_profile_hash"),
    ("run_knowledge_snapshots", "chk_run_knowledge_snapshot_sources"),
    ("run_knowledge_snapshots", "chk_run_knowledge_snapshot_versions"),
    ("run_knowledge_snapshots", "chk_run_knowledge_snapshot_hash"),
    ("run_knowledge_snapshots", "uq_run_knowledge_snapshot_fence"),
    ("knowledge_retrieval_attempts", "fk_knowledge_retrieval_attempt_run_attempt"),
    ("knowledge_retrieval_attempts", "fk_knowledge_retrieval_attempt_run"),
    ("knowledge_retrieval_attempts", "fk_knowledge_retrieval_attempt_snapshot"),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_status"),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_generation"),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_counts"),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_duration"),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_failure_code"),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_digest"),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_timeline"),
    (
        "knowledge_retrieval_attempts",
        "chk_knowledge_retrieval_attempt_terminal_receipt",
    ),
    ("knowledge_retrieval_attempts", "chk_knowledge_retrieval_attempt_terminal_counts"),
    ("knowledge_retrieval_attempts", "uq_knowledge_retrieval_attempt_fence"),
    ("knowledge_retrieval_attempts", "uq_knowledge_retrieval_attempt_identity"),
    ("knowledge_evidence", "fk_knowledge_evidence_attempt"),
    ("knowledge_evidence", "fk_knowledge_evidence_run"),
    ("knowledge_evidence", "fk_knowledge_evidence_source"),
    ("knowledge_evidence", "chk_knowledge_evidence_identity"),
    ("knowledge_evidence", "chk_knowledge_evidence_title"),
    ("knowledge_evidence", "chk_knowledge_evidence_content"),
    ("knowledge_evidence", "chk_knowledge_evidence_content_hash"),
    ("knowledge_evidence", "chk_knowledge_evidence_score"),
    ("knowledge_evidence", "chk_knowledge_evidence_rank"),
    ("knowledge_evidence", "chk_knowledge_evidence_position"),
    ("knowledge_evidence", "uq_knowledge_evidence_attempt_rank"),
    ("messages", "uq_messages_tenant_run_id"),
    ("knowledge_citations", "fk_knowledge_citation_message"),
    ("knowledge_citations", "fk_knowledge_citation_attempt"),
    ("knowledge_citations", "fk_knowledge_citation_evidence"),
    ("knowledge_citations", "fk_knowledge_citation_source"),
    ("knowledge_citations", "chk_knowledge_citation_identity"),
    ("knowledge_citations", "chk_knowledge_citation_generation"),
    ("knowledge_citations", "chk_knowledge_citation_ordinal"),
    ("knowledge_citations", "chk_knowledge_citation_title"),
    ("knowledge_citations", "chk_knowledge_citation_excerpt"),
    ("knowledge_citations", "chk_knowledge_citation_content_hash"),
    ("knowledge_citations", "chk_knowledge_citation_set_hash"),
    ("knowledge_citations", "chk_knowledge_citation_score"),
    ("knowledge_citations", "chk_knowledge_citation_position"),
    ("knowledge_citations", "uq_knowledge_citation_message_ordinal"),
    ("knowledge_citations", "uq_knowledge_citation_message_evidence"),
...
STATIC_INDEX_DEFINITIONS = (
    ...
    StaticIndexDefinition(
        ...
        ("tenant_id", "run_id"),
        (False, False),
        "status = any array['requested', 'retrieving']",
        unique=True,
    ),
    StaticIndexDefinition(
        "idx_knowledge_retrieval_attempt_due",
        "knowledge_retrieval_attempts",
        ("deadline_at", "tenant_id", "run_id", "id"),
        (False, False, False, False),
        "status = 'retrieving'",
    ),
    StaticIndexDefinition(
        "idx_knowledge_evidence_attempt",
        "knowledge_evidence",
        ("tenant_id", "run_id", "retrieval_attempt_id", "fused_rank"),
        (False, False, False, False),
    ),
    StaticIndexDefinition(
        "idx_knowledge_citations_message",
        "knowledge_citations",
        ("tenant_id", "message_id", "ordinal"),
        (False, False, False),
    ),
    StaticIndexDefinition(
