...
def test_current_status_docs_summarize_g8_b3_boundaries_without_overclaiming():
    ...
    assert "external env-file label 仍是 G0/source-authority / production-hardening 非闭合边界" in compact_roadmap_text
    ...
    assert "当前权威文档不再 使用旧的 `g8_ordinary_user_multi_agent_exposure` / 泛化 multi-agent exposure 命名" in compact_text
