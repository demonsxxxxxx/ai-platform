...
def test_foundation_alpha_poc_release_evidence_is_reviewed_redacted_and_bounded():
    ...
    assert "production_readiness_not_claimed" in smoke_followups
    assert "docker_sandbox_hardening_not_claimed" in smoke_followups
    assert "ordinary_user_multi_agent_exposure_not_claimed" in smoke_followups
