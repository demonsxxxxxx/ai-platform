...
def test_gate_status_snapshot_records_blockers_without_closure_claim():
    ...
    assert "sha256:23fc483694b4cffb555759cb6205b56608e16701577f54939a977942c9e1bdb4" in gate_status_text
...
def test_foundation_alpha_poc_release_evidence_is_reviewed_redacted_and_bounded():
    ...
    assert payload["evidence_id"] == "2026-06-11-211-foundation-alpha-poc-9b02836-context-output-smoke"
    assert payload["commit_sha"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
    assert payload["runtime_subject_commit_sha"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
    ...
    assert payload["source_ref"]["runtime_source_marker"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
    assert payload["source_ref"]["image"] == "ai-platform:9b02836-context-output"
    assert payload["source_ref"]["image_id"] == "sha256:23fc483694b4cffb555759cb6205b56608e16701577f54939a977942c9e1bdb4"
    assert payload["source_ref"]["image_labels"]["ai-platform.source-revision"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
    assert payload["source_ref"]["image_labels"]["org.opencontainers.image.revision"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
    ...
    assert auth_rbac_payload["evidence_id"] == "2026-06-11-211-foundation-alpha-poc-9b02836-auth-rbac-smoke"
    assert auth_rbac_payload["commit_sha"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
    assert auth_rbac_payload["runtime_subject_commit_sha"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
    assert "record_commit_sha" not in auth_rbac_payload
    assert (auth_rbac_payload["source_ref"].get("runtime_image") or auth_rbac_payload["source_ref"].get("image")) == "ai-platform:9b02836-context-output"
    assert auth_rbac_payload["source_ref"]["image_id"] == "sha256:23fc483694b4cffb555759cb6205b56608e16701577f54939a977942c9e1bdb4"
    assert auth_rbac_payload["source_ref"]["image_labels"]["ai-platform.source-revision"] == "9b02836262fb0f238a7f90b9705bf39a8b298158"
